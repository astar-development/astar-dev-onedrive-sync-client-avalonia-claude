...
public partial class SettingsView : UserControl
{
    ...
    {
        if (DataContext is SettingsViewModel vm) vm.Theme = AppTheme.Light;
    }

    private void OnThemeDarkClick(object? sender, RoutedEventArgs e)
    {
        if (DataContext is SettingsViewModel vm) vm.Theme = AppTheme.Dark;
    }

    private void OnThemeSystemClick(object? sender, RoutedEventArgs e)
    {
        if (DataContext is SettingsViewModel vm) vm.Theme = AppTheme.System;
    }
